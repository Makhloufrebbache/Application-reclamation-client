...
<div class="row">
 <div class="form-group">
  ...
  <div class="col-lg-3">
  <input class="form-control" type="text" name="USER_NOM" id="USER_NOM" value="<?php echo $user["USER_NOM"]; ?>" required />
     </div>
  </div>
</div>
...
<div class="row">
 <div class="form-group">
  ...
  <div class="col-lg-3">
  <input class="form-control" type="text" name="USER_PRENOM" id="USER_PRENOM" value="<?php echo $user["USER_PRENOM"]; ?>" required />
     </div>
  </div>
</div>
...
<div class="row">
 <div class="form-group">
  ...
  <div class="col-lg-3">
  <input class="form-control" type="text" name="USER_LOGIN" id="USER_LOGIN" value="<?php echo $user["USER_LOGIN"]; ?>" required />
     </div>
  </div>
</div>
<div class="row">
 <div class="form-group">
  ...
  <div class="col-lg-3">
  <input class="form-control" type="password" name="USER_MDP" id="USER_MDP" value="<?php echo $user["USER_MDP"]; ?>" required />
     </div>
  </div>
</div>
